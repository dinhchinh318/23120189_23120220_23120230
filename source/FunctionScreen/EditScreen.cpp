...
void EditScreen::pollEvent(sf::RenderWindow& window, sf::Event& event)
{
...
void EditScreen::handleClick(sf::Vector2f mousePos, AppScreen& screen, sf::RenderWindow& window) {
