...
void SearchScreen::pollEvent(sf::RenderWindow& window, sf::Event& event, AppScreen& screen)
{
    if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left) {
        ...
        // Nếu nhấn bất kỳ nút menu nào → reset field
...
bool SearchScreen::handleClicked(sf::Vector2f mousePos, AppScreen& screen, sf::RenderWindow& window)
{
