...
EditScreen::EditScreen(sf::Font& font, UITheme theme) : BaseScreen(font, theme),
...
vector<Phone> EditScreen::getPhone()
{
    return pList;
}

void EditScreen::pollEvent(sf::RenderWindow& window, sf::Event& event, AppScreen& screen)
{
...
bool EditScreen::handleClicked(sf::Vector2f mousePos, AppScreen& screen, sf::RenderWindow& window)
{
    ...
    BaseScreen::handleClicked(mousePos, screen, window);
    return false;
}